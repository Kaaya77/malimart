...
export const AdminGrowth = () => {
 ...
 <div className="w-8 h-8 rounded-xl bg-foreground flex items-center justify-center shadow-lg shadow-foreground/10 dark:shadow-white/10">
 ...
 <Button className="h-12 rounded-2xl bg-foreground text-white dark:text-black text-[10px] font-black uppercase tracking-[0.2em] hover:scale-[1.02] transition-transform" onClick={createCampaign}>
