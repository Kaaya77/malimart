...
export const AdminAIHero = () => {
    ...
    return (
        <div className="space-y-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {recommendations.map((rec) => (
                            <div key={rec.id} className={`flex flex-col bg-white dark:bg-primary border rounded-2xl ${rec.status === 'approved' ? 'border-green-500 shadow-[0_0_15px_rgba(34,197,94,0.2)]' : 'border-foreground/10 dark:border-background/10'} overflow-hidden`}>
                                {rec.products && (
            ...
            {activeTab === 'manual' && (
                <div className="max-w-2xl bg-white dark:bg-primary p-8 rounded-2xl border border-foreground/10 dark:border-background/10">
                    <div className="mb-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredProducts.map(product => (
                            <div key={product.id} className="bg-white dark:bg-primary border border-foreground/10 dark:border-background/10 rounded-2xl overflow-hidden flex flex-col">
                                <div className="h-48 overflow-hidden relative">
                                    ...
                                    <div className="absolute top-2 right-2 bg-white/90 dark:bg-black/90 px-2 py-1 text-[10px] font-bold uppercase tracking-wider backdrop-blur-sm">
