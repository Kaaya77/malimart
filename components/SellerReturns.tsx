            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
                    <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-none bg-primary dark:bg-background flex items-center justify-center shadow-none relative group overflow-hidden border border-foreground/10 dark:border-background/10">
                            ...
                            <RefreshCcw className="w-6 h-6 text-white dark:text-black relative z-10 group-hover:rotate-12 transition-transform duration-500" />
                        ...
                        <div className="space-y-1">
                            <p className="text-[10px] uppercase tracking-[0.4em] font-black text-foreground/40 dark:text-white/40">Merchant Support</p>
                        ...
                        <Card key={dispute.id} className="p-10 rounded-none bg-background dark:bg-background border border-foreground/10 dark:border-background/10 shadow-none group hover:border-foreground/30 dark:hover:border-background/30 transition-all duration-700 relative overflow-hidden">
                            ...
                            <div className="relative z-10 flex items-center gap-4 mb-8">
                                <div className="w-12 h-12 rounded-full border border-foreground/10 dark:border-white/10 overflow-hidden bg-primary/5 dark:bg-white/5">
                                    {dispute.buyer?.avatar_url ? (
                                        ...
                                        <div className="w-full h-full flex items-center justify-center text-sm font-serif text-foreground/40 dark:text-white/40">{dispute.buyer?.full_name?.charAt(0)}</div>
                                    )}
                                </div>
                                <div>
                                    <p className="text-[9px] font-black uppercase tracking-[0.3em] text-foreground/40 dark:text-white/40">Customer</p>
                                    <p className="text-sm font-bold text-foreground dark:text-white font-serif">{dispute.buyer?.full_name}</p>
                                </div>
                            </div>

                            <div className="relative z-10 p-6 bg-background dark:bg-white/[0.03] border border-foreground/5 dark:border-white/5 text-sm text-foreground/60 dark:text-white/60 leading-relaxed font-serif italic mb-10">
                            ...
                            <div className="relative z-10 flex flex-wrap gap-4">
                                {dispute.status === 'open' && (
                                    <>
                                        <Button 
                                            ...
                                            className="flex-1 h-14 rounded-none bg-primary dark:bg-white text-white dark:text-black text-[10px] font-black uppercase tracking-[0.2em] hover:scale-[1.02] transition-transform"
                                        >
                                        ...
                                        <Button 
                                            ...
                                            variant="outline"
                                            className="flex-1 h-14 rounded-none border-foreground/10 dark:border-white/10 text-foreground dark:text-white text-[10px] font-black uppercase tracking-[0.2em] hover:bg-red-500/5 hover:text-red-500 hover:border-red-500/30 transition-all"
                                        >
                                ...
                                <Button 
                                    ...
                                    variant="secondary"
                                    className="w-full h-14 rounded-none border-foreground/10 dark:border-white/10 text-foreground dark:text-white text-[10px] font-black uppercase tracking-[0.2em] hover:bg-primary hover:text-background dark:hover:bg-background dark:hover:text-foreground transition-all"
                                >
