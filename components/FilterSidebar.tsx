...
// Assuming a Slider component exists or I'll use a standard input
            ...
            {isOpen && (
                <>
                    ...
                    >
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {colors.map(color => (
                                        ...
                                        >
                                            ...
                                            <span className="text-[8px] uppercase tracking-[0.1em] opacity-0 group-hover:opacity-100 transition-opacity">{color}</span>
                                        </button>
                                    ))}
                                </div>
                            </section>
                            ...
                            <section className="space-y-4">
                                ...
                                <label className="flex items-center justify-between cursor-pointer group">
                                    ...
                                    <div 
                                        ...
                                        className={`w-12 h-6 rounded-full transition-all relative ${stock ? 'bg-primary dark:bg-background' : 'bg-primary/20 dark:bg-background/20'}`}
                                    >
                        ...
                        <div className="p-6 border-t border-foreground/10 dark:border-background/10 grid grid-cols-2 gap-4">
                            <button 
                                onClick={handleReset}
