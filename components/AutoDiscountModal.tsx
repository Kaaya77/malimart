...
export const AutoDiscountModal = ({ isOpen, onClose, product, onSave }: { isOpen: boolean, onClose: () => void, product: Product | null, onSave: () => void }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            <div className="relative w-full max-w-md bg-background dark:bg-background border border-foreground/10 shadow-2xl flex flex-col animate-in zoom-in-95 duration-300">
                ...
                <div className="p-6 space-y-6">
                    <div className="space-y-2">
                        <label className="text-[10px] uppercase tracking-[0.2em] opacity-60 text-foreground flex items-center gap-2">
                        ...
                        <Input 
                            ...
                            className="h-12 bg-transparent border-foreground/20 rounded-none focus:border-foreground dark:focus:border-background"
                        />
                    </div>
