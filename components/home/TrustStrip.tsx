      ...
      {ITEMS.map((it, i) => {
        ...
        return (
          ...
          >
            ...
            <p className="text-[13px] md:text-sm font-semibold text-foreground leading-tight">{it.label}</p>
            <p className="text-[11px] md:text-xs text-foreground/50 mt-1 leading-snug">{it.sub}</p>
          </motion.div>
        );
      })}
    </div>
