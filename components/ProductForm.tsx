                            ...
                            {step === 'logistics' && (
                                ...
                                <div className="space-y-10">
                                    ...
                                    <div className="p-8 bg-primary/5 dark:bg-background/5 border border-foreground/10 dark:border-background/10">
                                        ...
                                        {attributes.length > 0 && <Button size="sm" variant="outline" onClick={() => setAttributes([...attributes, { name: 'Size', values: [] }])} className="w-full border-dashed mt-4 rounded-none"><Plus className="w-4 h-4 mr-2"/> Add Attribute Rail</Button>}
                                    </div>
