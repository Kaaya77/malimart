      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}
          ...
          <div className="flex items-center gap-3.5 min-w-0">
            {contextVendor?.logo_url ? (
              <img src={contextVendor.logo_url} alt="" className="w-12 h-12 rounded-2xl object-cover ring-2 ring-foreground/10 shadow-md shrink-0" loading="lazy" decoding="async" />
            ) : (
            ...
            <div className="min-w-0">
              ...
              <h1 className="text-xl md:text-2xl font-bold text-foreground tracking-tight truncate">
                {contextVendor?.store_name || user.name}
              </h1>
            </div>
          </div>
