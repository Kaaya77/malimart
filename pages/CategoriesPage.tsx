...
export const CategoriesPage = () => {
 ...
 className="px-4 py-2 border border-foreground/10 text-[10px] uppercase tracking-widest text-foreground/60 hover:border-foreground hover:text-foreground transition-all"
 >
 {sub.name}
 </Link>
 </motion.div>
 ...
 <Link 
 to="/about"
 className="px-12 py-5 border border-foreground dark:border-background text-foreground text-[11px] uppercase tracking-[0.3em] font-bold hover:bg-primary hover:text-background dark:hover:text-foreground transition-all"
 >
 Learn Our Process
 </Link>
 </div>
