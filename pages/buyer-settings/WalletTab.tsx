                ...
                <CardContent className="p-8 md:p-10 relative">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="mt-8 flex items-center gap-3 flex-wrap">
                        ...
                        <span className="text-[10px] font-semibold uppercase tracking-widest text-white/50 dark:text-slate-900/50">Coming soon</span>
                      </div>
                    </div>
                </CardContent>
              </Card>
                    ...
                    <CardContent>
                        {walletTransactions.length === 0 ? (
                            <EmptyState
                                ...
                                subtitle="Wallet activity like refunds, referral rewards, and purchases will show up here."
                                className="py-10"
                            />
                        ) : (
